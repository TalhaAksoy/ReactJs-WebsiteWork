	...
	return (
		<div className='info bg-base-100 w-full h-10 flex justify-center'>
			<div className='middle w-3/4 h-full flex'>
				...
				<div className='middleRight w-1/2 mr-2 h-full flex items-center justify-end'>
					<button className='btn btn-primary btn-sm rounded-sm'>İletişim</button>
				</div>
				{/* <div class="dropdown dropdown-end">
					<label tabindex="0" class="btn btn-ghost rounded-btn relative">Select Theme</label>
					<ul tabindex="0" class="menu dropdown-content p-2 shadow bg-base-100 rounded-box w-52 mt-4 absolute top-3/4 right-0 z-50 border-2">
...
function NavbarDesktop() {
	return (
		<div className="App sticky top-0 left-0 z-40 w-full sm:block hidden">
...
function CardDesktop() {
	return (
		<div className='mt-5 mr-2 w-1/4'>
			<div class="card w-full mx-auto bg-base-100 drop-shadow-xl items-center">
...
function CompanyProp() {
	return (
		<div className='company-prop w-full mt-5 flex justify-center mx-auto'>
			<div className='mt-5 mb-5 mr-5 w-1/5 flex justify-center items-center'>
